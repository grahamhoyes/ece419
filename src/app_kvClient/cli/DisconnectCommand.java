...
public class DisconnectCommand extends AbstractCommand {
    ...
    private final static String commandDescription = "\tTries to disconnect from the connected server.";
    private final static String commandParameters = "";
    private final static String commandOutput = "\t\tstatus report: Once the client got disconnected from the server, it should provide a suitable notification to the user.";
